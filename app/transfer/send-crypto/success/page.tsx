...
function SendCryptoSuccessContent() {
        ...
        <div className="w-full max-w-sm bg-white dark:bg-slate-800 rounded-xl p-6 shadow-2xl relative overflow-hidden border border-slate-100 dark:border-slate-700">
          ...
          <div className="text-center mb-8 pt-2">
            ...
            <div className="flex items-center justify-center gap-1">
              <span className="text-4xl font-extrabold tracking-tighter text-slate-800 dark:text-white">{parseFloat(qty).toFixed(6)}</span>
...
export default function SendCryptoSuccessPage() {
  return (
